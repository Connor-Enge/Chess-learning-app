...
export const LESSONS_POSITIONAL_1 = [
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: "board", fen: "4k3/pp3ppp/2p5/3p4/3P4/2P1P3/PP3PPP/4K3 w - - 0 1", caption: "Black's c6 is **backward**. The b- and d-pawns have advanced past it (well, d5 has). If Black pushes …c5, White takes with dxc5 and the d-pawn becomes weak too. Meanwhile c6 sits exposed, and **the c5 square is a permanent hole** for a White piece." },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: "board", fen: "4k3/p4ppp/4p3/8/3P4/8/P4PPP/4K3 w - - 0 1", caption: "An isolated d4 pawn in a simplified position. Without pieces around to give it dynamic life, this is just a target. Black's plan is the textbook one: blockade d5 with a knight, double rooks on the d-file, and grind." },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: "board", fen: "4k3/p4ppp/2p1p3/2p5/8/2P5/PP3PPP/4K3 w - - 0 1", caption: "Black has doubled c-pawns AND they're isolated (no b- or d-pawn). About as bad as it gets — three weaknesses in one structure. White's plan is to bring rooks to the half-open c-file and grind." },
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: "board", fen: "4k3/pp3ppp/8/2pp4/8/2P1P3/PP3PPP/4K3 w - - 0 1", caption: "Black's hanging pawns on c5 and d5. They control b4, c4, d4, and e4 — a strong central wedge. They threaten …c4 or …d4 to either advance further or trade favorably. But they're targets too: White will pile up on them with pieces and try to fix them in place." },
